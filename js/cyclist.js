...
class Slideshow {
    constructor(el) {
        ...
        this.showSlider(`home-slider-${this.current + 1}`);
    }
    initEvents() {
    ...
    showSlider(el) {
        ...
        console.log('inside coder function')
        // this.sliders = Array.from(document.querySelector('.home-slider').querySelectorAll('.home-slider__item'));

        let activeSlide = document.querySelector('.' + el);
...
let slideShow = new Slideshow(document.querySelector('.bike-nav'));
