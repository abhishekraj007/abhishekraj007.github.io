$(function () {
  ...
  var initProgram = function () {
    setTimeout(function () {
      ...
      var $JSFrameworks = "Javascript Frameworks: React | Meteor";
      var $JSLibs = "Javascript Libraries: jQuery | D3 | C3";
      var $CSSFrameworks = "CSS Experise: Bootstrap4 | Semantic UI MaterialDesign | Canvas | SVG | SASS";
      var $branding = "Illustration & Branding: Photoshop CC | Illustrator CC";
      var $hobby = "Hobby: Cycling, Spening time with pets and books";
  ...
  var resumeContent = "\n<p><strong>Name:</strong> Abhishek Raj (aka: AKRJ)</p>" +
    "<p><strong>Occupation:</strong> Front End Engineering | UI Developement</p>" +
    "<p><strong>Front End Core:</strong> HTML5 | CSS3 | Javascript</p>" +
    "<p><strong>Javascript Frameworks:</strong> React | Meteor</p>" +
    "<p><strong>Javascript Libraries:</strong> jQuery | D3 | Underscore</p>" +
    "<p><strong>CSS Experise:</strong> Bootstrap4 | Semantic UI MaterialDesign | Canvas | SVG | SASS</p>" +
    "<p><strong>Illustration & Branding:</strong> Photoshop CC | Illustrator CC</p>" +
    "<p><strong>Hobby:</strong> Cycling, Spening time with pets and books</p>";
